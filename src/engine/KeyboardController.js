...
export class KeyboardController {
  ...
  _onKeyDown(e) {
    ...
    if (['ArrowUp','ArrowDown','ArrowLeft','ArrowRight','Space','KeyE','KeyI'].includes(e.code)) {
      e.preventDefault();
    }
  }
  ...
  wasJustReleased(code) {
    return this.justReleased.has(code);
  }

  /**
   * Clear transient states - call at end of each update frame
   */
  flush() {
  ...
  // Convenience getters for directional movement
